...
<body>
  <div class="container">
    <nav class="navbar navbar-light bg-info object-fit-cover border rounded mt-3">
    ...
    <figure class="text-center mt-4">
      <blockquote class="blockquote">
        <p>Data Booking Hotel</p>
      </blockquote>
      <figcaption class="blockquote-footer">
        <cite title="Source Title">Hotel Mona</cite>
      </figcaption>
    </figure>
    <a href="tambah.php" class="tambah text-decoration-none">
    ...
    <a href="dowload-pdf.php" class="dowload-pdf" target="_blank">
